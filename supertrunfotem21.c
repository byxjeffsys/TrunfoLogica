...
int main(){
    ...
    //Menu interativo - Escola do atributo para comparação

    int atributo;

    printf("##**AGORA O JOGO COMEÇA!**##\n");
    ...
    switch (atributo) {
        ...
        if (populacao1 > populacao2) {
            printf("Carta 1 possui uma população de %lu pessoas e Carta 2 possui %lu pessoas.\n", populacao1, populacao2);
        ...
        case 2:
        if (area1 > area2) {
            printf("Carta 1 possui uma área de %.2f km² e Carta 2 possui uma área de %.2f km² \n.", area1, area2);
            printf("Carta 1 venceu!");
        } 
        else if (area1 == area2) {
            printf("Os atributos empataram!");
            ...
            printf("Carta 1 possui uma área de %.2f km² e Carta 2 possui uma área de %.2f km² .", area1, area2);
            printf("Carta 2 venceu!");
        }
        break;
        case 3:
        if (pib1 > pib2) {
            printf("Carta 1 possui um PIB de R$ %.2f e Carta 2 possui uma PIB de %.2f .", pib1, pib2);
            printf("Carta 1 venceu!");
        } 
        else if (pib1 == pib2) {
            printf("Os atributos empataram!");
        ...
        if (pturisticos1 > pturisticos2) {
            printf("Carta 1 possui %d pontos turísticos e Carta 2 possui %d pontos turísticos.", pturisticos1, pturisticos2);
            printf("Carta 1 venceu!");
        } 
        ...
        if (densidade1 < densidade2) {
            printf("Carta 1 possui uma densidade de %.2f e Carta 2 possui uma densidade de %.2f", densidade1, densidade2);
            printf("Carta 1 venceu!");
        } 
